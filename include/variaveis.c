...
//cria��o de variaveis
	int i,j,y,z,opcoes_menu, opcoes_cad_cliente, opcoes_cad_produto, quantidade_rifas,faz_sorteio, rifa_do_cliente[TOTAL_VETORES],rifas_compradas[TOTAL_VETORES], cont, cont25, total_clientes;
