...
//cria��o de variaveis
	int i,j,y,z,opcoes_menu, opcoes_cad_cliente, opcoes_cad_produto, quantidade_rifas,faz_sorteio,num_sorteados[5],num_ja_sorteados[5], rifa_do_cliente[TOTAL_VETORES][TOTAL_VETORES],rifas_compradas[TOTAL_VETORES],cpf_igual,coluna, cont, cont25, total_clientes, id_cliente[TOTAL_VETORES], id_cliente_verifica, achou,quantidade_rifas_cliente[TOTAL_VETORES];
